...
var ArenaGame = {
  ...
  saveGameResult: async function() {
    ...
    // Try MegaETH on-chain leaderboard - KING OF THE HILL!
    // Costs 0.0001 ETH: 70% pool, 20% to king, 10% to house
    if (typeof MegaETH !== 'undefined' && MegaETH.account && MegaETH.leaderboardAddress) {
      try {
